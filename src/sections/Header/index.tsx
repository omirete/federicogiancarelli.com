  ...
  return (
    <div className="mt-4 d-flex flex-column flex-fill">
      ...
      <div className="flex-fill d-flex flex-column justify-content-center">
        <SignatureLine className="w-100 mt-5 text-center align-center mt-3 fill-white opacity-75" style={{height: '2.5ch'}} />
        <SocialRow
      ...
      <div className="d-flex flex-column align-items-center justify-content-center mt-4 mb-5 pb-5 mb-md-3 pb-md-3">
        ...
        <IconChevronCompactDown className="d-block fill-light opacity-50 h1" style={{width: '1em', height: '1em'}} />
      </div>
    </div>
  )
}
