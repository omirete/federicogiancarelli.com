...
const About: React.FC = () => {
  ...
  const aboutContent = [
    { icon: <IconFlagArg style={iconStyles} />, text: lang.text.about_1 },
    { icon: <IconBooks style={iconStyles} />, text: lang.text.about_2 },
    { icon: <IconBoyLaptop style={iconStyles} />, text: lang.text.about_3 },
    { icon: <IconWorld style={iconStyles} />, text: lang.text.about_4 },
    { icon: <IconScale style={iconStyles} />, text: lang.text.about_5 },
    { icon: <IconAirplane style={iconStyles} />, text: lang.text.about_6 },
  ]
  const iconClasses =
